// flows/receipt/screens/InvoiceAllocationScreen.tsx
...
const InvoiceAllocationScreen: React.FC = () => {
  ...
  const handleAllocateFull = useCallback(() => {
    ...
    setEditingInvoice(null);
    setEditAmount('');
  }, [editingInvoice, amount, allocationSummary.totalAllocated, dispatch]);
  ...
  const renderInvoiceItem = useCallback(
    ({ item: invoice }: { item: PendingInvoice }) => {
        ...
        <View style={styles.actionBar}>
          ...
          >
            <LightningIcon
              ...
              weight="fill"
            />
            <Text style={styles.autoAllocateText}>Auto-Allocate</Text>
          </TouchableOpacity>
        ...
        pendingInvoices.length > 0 && (
          <View style={styles.warningBanner}>
            ...
            <Text style={styles.warningText}>
              PKR {allocationSummary.unallocatedAmount.toLocaleString()} will be
              recorded as advance payment
            </Text>
          </View>
        )}
        ...
        {pendingInvoices.length > 0 ? (
          <>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.skipButtonText}>Skip Allocation</Text>
            </TouchableOpacity>
            <View style={styles.continueButton}>
              <ActionButton title="Continue" onPress={handleContinue} />
            </View>
          </>
        ) : (
          <ActionButton title="Continue" onPress={handleContinue} />
