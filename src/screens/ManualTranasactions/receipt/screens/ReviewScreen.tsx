// flows/receipt/screens/ReviewScreen.tsx
// Review screen showing all receipt details before submission
...
const ReviewScreen: React.FC = () => {
  ...
  const bankAccountId = useAppSelector(selectReceiptBankAccountId);
  ...
  const notes = useAppSelector(state => state.receipts.notes);
  ...
  const handleConfirmReceipt = useCallback(async () => {
    try {
      dispatch(clearError());
      await dispatch(submitReceiptPayment()).unwrap();
      ...
      Alert.alert(
        'Receipt Failed',
        err.message || 'Failed to record receipt. Please try again.',
        [{ text: 'OK' }],
      );
    }
  }, [dispatch, navigation]);
    ...
    <SafeAreaView style={styles.container} edges={['bottom']}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          {customer?.phoneNumber && (
            <Text style={styles.cardSubvalue}>{customer.phoneNumber}</Text>
          )}
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.amountRow}>
            <Text style={styles.amountLabel}>
              {isAdvance ? 'Advance Amount' : 'Remaining After Receipt'}
            </Text>
            <Text
              style={[
        ...
        <View style={styles.card}>
          <View style={styles.cardHeader}>
            <CalendarIcon
              ...
              weight="fill"
            />
            <Text style={styles.cardTitle}>Receipt Date</Text>
          </View>
          <Text style={styles.cardValue}>
      ...
      <View style={styles.footer}>
        <View style={styles.footerButtons}>
          ...
          />
          <ActionButton
            title={isLoading ? 'Processing...' : 'Confirm Receipt'}
        ...
        {isLoading && (
          <View style={styles.loadingOverlay}>
            ...
            <Text style={styles.loadingText}>Recording receipt...</Text>
          </View>
        )}
      </View>
    </SafeAreaView>
