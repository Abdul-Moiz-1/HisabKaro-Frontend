// flows/bankTransfer/screens/WithdrawalScreen.tsx
...
const WithdrawalScreen: React.FC = () => {
  ...
  const handleWithdrawal = () => {
    ...
    if (amount > (selectedBank?.balance || 0)) {
      Alert.alert('Insufficient bank balance');
      return;
    }
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        {/* Amount Section */}
        <Text style={styles.question}>How much to withdraw?</Text>
        ...
        {/* Date Section */}
        <Text style={styles.sectionTitle}>Withdrawal Date</Text>
      ...
      <View style={styles.footer}>
        <ActionButton
          ...
          disabled={
            !amount || !selectedBankId || amount > (selectedBank?.balance || 0)
          }
        />
      </View>
    </SafeAreaView>
